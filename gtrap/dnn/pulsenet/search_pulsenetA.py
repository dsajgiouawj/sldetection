...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', nargs=1, default=["/home/kawahara/gtrap/examples/picklcslc/101/npz"],help='directory containing train sets generated by gtls_slctess.', type=str)
